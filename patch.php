...
/* ----------------------------------------------------------------------------
 * MYAppointments - Patch Utility Script
 *
 * @package     MYAppointmentsPatch
 * @version     1.0.0
 * @author      Adorratm <https://github.com/adorratm>
 * @copyright   Copyright (c) 2013 - 2022, Adorratm
 * @license     https://opensource.org/licenses/GPL-3.0 - GPLv3
 * @link        https://mutfakyapim.com
 * @support     MYAppointments v1.x.x
 * ---------------------------------------------------------------------------- */
...
function detect_local_version()
{
    ...
    {
        die('Failed to detect the local MYAppointments version, please move the patch.php script in the root directory of your MYAppointments installation.');
    }
...
echo LINE_BREAK . '➜ MYAppointments - Patch Utility Script' . LINE_BREAK . LINE_BREAK;

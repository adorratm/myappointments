...
$lang['about_app'] = 'Info su MYAppointments';
...
$lang['about_app_info'] = 'MYAppointments è un\'applicazione web estremamente personalizzabile che permette ai tuoi clienti di prenotare appuntamenti con te attraverso il web. Inoltre, fornisce la possibilità di sincronizzare i tuoi dati con Google Calendar in modo da poterli usare in altri servizi.';
$lang['current_version'] = 'Versione corrente';
$lang['support'] = 'Supporto';
$lang['about_app_support'] = 'Se incontri un problema quando utilizzi MYAppointments puoi cercare sul Gruppo Google ufficiale per le risposte. Potresti anche aver bisogno di creare una nuova segnalazione sulla pagina Google Code al fine di aiutarci negli sviluppi futuri.';
...
$lang['about_app_license'] = 'MYAppointments è distributo sotto licenza GPLv3. Usando il codice di MYAppointments stai accettando i termini e le condizioni descritte al seguente URL:';
...
$lang['ea_update_success'] = 'MYAppointments è stato aggiornato con successo.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the MYAppointments API.';

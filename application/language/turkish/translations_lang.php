...
$lang['about_app'] = 'MYAppointments Hakkında';
...
$lang['about_app_info'] = 'MYAppointments yüksek ölçüde özelleştirilebilen, müşterilerinizin web üzerinden randevu almasını sağlayan bir uygulamadır. Ayrıca, bilgilerinizi Google Takvim ile eşitleyerek diğer uygulamalarla da entegre olmasını sağlar. ';
$lang['current_version'] = 'Mevcut Versiyon';
$lang['support'] = 'Destek';
$lang['about_app_support'] = 'MYAppointments kullanımı sırasında sorun yaşamanız halinde resmi Google Group üzerinde arama yapabilirsiniz. Ayrıca geliştirmeye destek olmak için Google Code sayfasında yeni sorun girişi de yapabilirsiniz.';
...
$lang['license'] = 'Lisans';
$lang['about_app_license'] = 'MYAppointments GPLv3 kapsamında lisanslıdır. Bu yazılımı herhangi bir biçimde kullanarak aşağıdaki adreste belirtilen koşulları kabul etmiş olursunuz:';
...
$lang['licensed_under'] = 'Tüm Hakları Saklıdır. ';
...
$lang['ea_update_success'] = 'MYAppointments başarı ile güncellendi.';

 ...
 * Class Google_sync
 *
 * This class implements all the core synchronization between the Google Calendar and the MYAppointments system.
 *
...
class Google_sync {
     ...
     * where the user grants access to his data for the MYAppointments app.
     */
     ...
     * when the provider granted consent to MYAppointments for use his
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of MYAppointments
     ...
     * provided appointment record of MYAppointments.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.

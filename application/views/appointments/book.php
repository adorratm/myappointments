                        ...
                        <div class="col-12 col-md-6">
                            <div id="select-time">
                                <div class="form-group">
                                    ...
                                    <?= render_timezone_dropdown('id="select-timezone" class="form-control" value="Europe/Istanbul"'); ?>
                                </div>
            ...
            <div id="frame-footer">
                <small>
                    <span class="footer-powered-by">
                        ...
                        <a href="https://mutfakyapim.com" title="Mutfak Yapım Dijital Reklam Ajansı" target="_blank">Mutfak Yapım Dijital Reklam Ajansı</a>
                    </span>

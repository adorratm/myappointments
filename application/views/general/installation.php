...
<head>
    ...
    <title>Installation | MYAppointments</title>
...
<header>
    <div class="container">
        <h1 class="page-title">MYAppointments Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the MYAppointments installation page.</h3>
        <p>
            This page will help you set the main settings of your MYAppointments installation.
            ...
            url to connect to the backend section of MYAppointments.
        </p>
    </div>
    ...
    <p>
    <h3>License</h3>
    MYAppointments is licensed under the <span class="badge badge-default">GPL-3.0 license</span>.
    By using the code of MYAppointments in any way <br> you agree with the terms described in the
    following url:
...
<footer>
    Powered by <a href="https://mutfakyapim.com" title="Mutfak Yapım Dijital Reklam Ajansı">Mutfak Yapım Dijital Reklam Ajansı</a>
</footer>

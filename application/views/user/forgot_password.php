...
<head>
    ...
    <title><?= lang('forgot_your_password') ?> | MYAppointments</title>
...
<body>
    <div id="forgot-password-frame" class="frame-container">
        ...
        <div class="mt-4">
            <small>
                Powered by
                <a href="https://mutfakyapim.com" title="Mutfak Yapım Dijital Reklam Ajansı">Mutfak Yapım Dijital Reklam Ajansı</a>
            </small>
        </div>
    </div>

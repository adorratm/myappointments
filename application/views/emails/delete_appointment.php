<html lang="tr">
<head>
    <title><?= lang('appointment_cancelled_title') ?> | MYAppointments</title>
</head>
...
<div class="email-container" style="width: 650px; border: 1px solid #eee;">
    ...
    <div id="footer" style="padding: 10px; text-align: center; margin-top: 10px;
        ...
        Powered by
        <a href="https://mutfakyapim.com" title="Mutfak Yapım Dijital Reklam Ajansı" style="text-decoration: none;">Mutfak Yapım Dijital Reklam Ajansı</a>
        |

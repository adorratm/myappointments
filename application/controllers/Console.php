 ...
 * Class Console
 *
 * CLI commands of MYAppointments, can only be executed from a terminal and not with a direct request.
 */
class Console extends EA_Controller {
     ...
     *
     * Use this method to install MYAppointments directly from the terminal.
     *
     * Usage:
     *
     ...
     *
     * Use this method to backup your MYAppointments data.
     *
     * Usage:
     *
    ...
    public function backup()
    {
        ...
        $filename = 'myappointments-backup-' . date('Y-m-d-His') . '.gz';
     ...
     *
     * Use this method in a cronjob to automatically sync events between MYAppointments and Google Calendar.
     *
     * Notice:
     *

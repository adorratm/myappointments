...
(function () {
    ...
    ServicesHelper.prototype.save = function (service) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_save_service';
    ...
    ServicesHelper.prototype.delete = function (id) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_service';
    ...
    ServicesHelper.prototype.filter = function (key, selectId, display) {
        ...
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_filter_services';

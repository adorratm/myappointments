...
(function (exports) {
    ...
    exports.saveWorkingPlanException = function (date, workingPlanException, providerId,
        ...
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_save_working_plan_exception';
    ...
    exports.deleteWorkingPlanException = function (date, providerId, successCallback, errorCallback) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_working_plan_exception';

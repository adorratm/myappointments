...
(function () {
    ...
    CustomersHelper.prototype.save = function (customer) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_save_customer';
    ...
    CustomersHelper.prototype.delete = function (id) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_customer';
    ...
    CustomersHelper.prototype.resetForm = function () {
        $('.record-details')
            ...
            .val('')
            .prop('disabled', true);
        $('.record-details #timezone').val('Europe/Istanbul');
    ...
    CustomersHelper.prototype.display = function (customer) {
        ...
        $('#language').val(customer.language || 'turkish');
        ...
        customer.appointments.forEach(function (appointment) {
            ...
            $('<div/>', {
                ...
                'html': [
                    ...
                    $('<a/>', {
                        'href': GlobalVariables.baseUrl + '/backend/index/' + appointment.hash,
                        'html': [
                            $('<i/>', {
    ...
    CustomersHelper.prototype.filter = function (key, selectId, display) {
        ...
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_filter_customers';

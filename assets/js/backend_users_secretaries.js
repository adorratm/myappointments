...
(function () {
    ...
    SecretariesHelper.prototype.save = function (secretary) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_save_secretary';
    ...
    SecretariesHelper.prototype.delete = function (id) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_secretary';
    ...
    SecretariesHelper.prototype.resetForm = function () {
        ...
        $('#secretaries .record-details #secretary-timezone').val('Europe/Istanbul');
    ...
    SecretariesHelper.prototype.filter = function (key, selectId, display) {
        ...
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_filter_secretaries';

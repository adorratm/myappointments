...
(function () {
    ...
    ProvidersHelper.prototype.save = function (provider) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_save_provider';
        var data = {
    ...
    ProvidersHelper.prototype.delete = function (id) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_provider';
        var data = {
            csrfToken: GlobalVariables.csrfToken,
            provider_id: id
        };
    ...
    ProvidersHelper.prototype.resetForm = function () {
        ...
        $('#providers .record-details #provider-timezone').val('Europe/Istanbul');

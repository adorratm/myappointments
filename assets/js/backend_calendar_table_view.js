    ...
    function bindEventHandlers() {
        ...
        $calendar.on('click', '.delete-popover', function () {
            ...
            if (lastFocusedEventData.data.workingPlanException) {
                ...
                url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_working_plan_exception';
                ...
                var buttons = [
                    ...
                    },
                    {
                        text: 'OK',
                        click: function () {
                            url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_appointment';
                ...
                // Do not display confirmation prompt.
                url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_unavailable';

...
(function () {
    ...
    AdminsHelper.prototype.save = function (admin) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_save_admin';
    ...
    AdminsHelper.prototype.delete = function (id) {
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_delete_admin';
    ...
    AdminsHelper.prototype.resetForm = function () {
        ...
        $('#admins .record-details #admin-timezone').val('Europe/Istanbul');
    ...
    AdminsHelper.prototype.filter = function (key, selectId, display) {
        ...
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_filter_admins';

...
(function (exports) {
    ...
    function bindEventHandlers() {
        ...
        $('#enable-sync').on('click', function () {
            if ($('#enable-sync').hasClass('enabled') === false) {
                ...
                var windowHandle = window.open(authUrl, 'Authorize MYAppointments',
                    ...
                    try {
                        if (windowHandle.document) {
                            if (windowHandle.document.URL.indexOf(redirectUrl) !== -1) {
                                ...
                                // the sync calendar.
                                var url = GlobalVariables.baseUrl + '/backend_api/ajax_get_google_calendars';
        ...
        $('#select-calendar').on('click', function () {
            var url = GlobalVariables.baseUrl + '/backend_api/ajax_select_google_calendar';
    ...
    function disableProviderSync(providerId) {
        ...
        var url = GlobalVariables.baseUrl + '/backend_api/ajax_disable_provider_sync';

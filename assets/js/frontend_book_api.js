...
(function (exports) {
    ...
    exports.getAvailableHours = function (selectedDate) {
        ...
        var url = GlobalVariables.baseUrl + '/appointments/ajax_get_available_hours';
    ...
    exports.registerAppointment = function () {
        ...
        var url = GlobalVariables.baseUrl + '/appointments/ajax_register_appointment';
        ...
        $.ajax({
            ...
            .done(function (response) {
                ...
                window.location.href = GlobalVariables.baseUrl
                    + '/appointments/book_success/' + response.appointment_hash;
            })
